            ...
            <div className="row align-items-center min-vh-100 flex-row-reverse">
              <div className="col-lg-6 ps-xl-5 mb-5 mb-lg-0">
                <div className="home-intro">
                  <h6>👋 Hi, I’ m</h6>
                  <h1>Vanessa <span><img src="assets/img/mask.jpg" alt="title" /></span>Nascimento</h1>

                  <h2>I{"'"}m a <TypeWriter /> </h2>
                  <p className="pe-lg-5">I like to create things, from snazzy videos to cozy crochet pieces and doodles that dance on paper. Dive into my world of playful artistry!</p>
                  <div className="btn-bar">
                    <a className="px-btn px-btn-theme" href="#contactus">Download cv <i className="bi-download" /> </a>
                  </div>
                </div>
              </div>
              <div className="col-lg-6">
                <div className="home-image text-center">
                  ...
                  <img src="assets/img/home-banner.png" alt="title" />
                </div>
              </div>
            </div>
          </div>
